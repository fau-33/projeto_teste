...
function bs_theme_styles() {
	...
	wp_enqueue_style("clearblog", get_template_directory_uri()."/css/clean-blog.min.css");
	...
	wp_enqueue_script("clearblog_js", get_template_directory_uri()."/js/clean-blog.min.js");
}
...
function bs_after_setup() {
	...
	register_nav_menu("primary", __('Primary Menu', 'segundatema'));
}